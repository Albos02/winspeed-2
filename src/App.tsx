...
export default function App() {
  ...
  if (!recording) {
    return (
      <div className="flex flex-col items-center justify-center h-screen gap-6 p-4">
        ...
        <button className="p-4 border-2 border-current rounded" onClick={() => setLayout(l => l === '2' ? '4' : '2')}>
          Layout: {layout}-data
        </button>
  ...
  return (
    <div className={`grid h-[calc(100vh-10px)] w-[calc(100vw-10px)] p-1 gap-1 ${layout === '2' ? 'grid-rows-2' : 'grid-cols-2 grid-rows-2'}`}>
